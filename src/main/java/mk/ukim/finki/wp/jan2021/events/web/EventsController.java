...
public class EventsController {
    ...
    public String showEvents(@RequestParam(required = false) Double price,
        ...
        List<EventType> eventTypeList = Arrays.stream(EventType.values()).collect(Collectors.toList());
        model.addAttribute("type", eventTypeList);
        model.addAttribute("events", this.eventService.listAllEvents());
        model.addAttribute("eventLocations", this.eventLocationService.listAll());
        return "list.html";
    }
